		...
		<section>
			...
			<div class="login-box">
				...
				<form action="process-login.php" method="POST" id="form-login">
					...
					<?php if (isset($msgtxt)) { echo "<div class='msgbox msgbox-fullwidth msgbox-$msgtype' data-expire='$msgexpire'><i class='fas fa-$msgicon'></i><span>" . $msgtxt . "</span></div>"; } ?>
					...
					<button id="form-login-submit" class="form-login-submit" type="submit"><i class="fas fa-sign-in-alt" data-fa-transform="up-1"></i>Proceed</button>
