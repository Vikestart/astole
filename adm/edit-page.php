...
?>
	...
	<main id="page-default">
		...
		<section>
			<?php if (!$page_isnew) { echo "<a class='btn btn-red btn-r' href='process-page.php?a=del&p=$page_id'><i class='fa-solid fa-trash-alt' data-fa-transform='up-1'></i>Delete Page</a>"; } ?>
			<h1 class="h1_underscore"><i class="fa-solid fa-<?php echo ($page_isnew) ? "file-plus" : "file-edit"; ?>"></i><?php echo ($page_isnew) ? "New Page" : "Edit Page: " . $page_title; ?></h1>
