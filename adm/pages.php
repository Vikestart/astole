...
?>
	...
	<main id="page-default">
		...
		<section>
			...
			<h1 class="h1_underscore h1_lessmargin"><i class="fas fa-layer-group" data-fa-transform="down-1"></i>Pages management</h1>
			...
			<?php
				if ($pageslist->result->num_rows > 0) {
				    ...
				    while($pageslist->row = $pageslist->result->fetch_assoc()) {
				        echo "<li><a href='edit-page.php?t=edit&p=" . $pageslist->row['page_id'] . "'><i class='fas fa-file'></i>" . $pageslist->row['page_title']. "</a></li>";
				    }
						echo '</ul>';
				} else {
